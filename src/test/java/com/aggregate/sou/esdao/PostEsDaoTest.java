package com.aggregate.sou.esdao;
...
public class PostEsDaoTest {
    ...
    void testAdd() {
        ...
        postEsDTO.setId(1L);
        postEsDTO.setTitle("李四的故事");
        postEsDTO.setContent("李四，不是ikun");
        postEsDTO.setTags(Arrays.asList("ikun"));
    ...
    void testFindByTitle() {
        List<PostEsDTO> postEsDTOS = postEsDao.findByTitle("");
        System.out.println(postEsDTOS);
    }

    @Test
    void testFindByContent(){
        List<PostEsDTO> content = postEsDao.findByContent("效率");
